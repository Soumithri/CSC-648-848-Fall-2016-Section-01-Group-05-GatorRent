...
$(document).ready(function(){ $("input:radio[name=price]").click(function(){
    // window.location.replace("http://google.com/");
    // window.open(this.href, "http://google.com");
     alert($(this).val());
  });
});

$(document).ready(function(){ $("input:radio[name=distance]").click(function(){
    // window.location.replace("http://google.com/");
    // window.open(this.href, "http://google.com");
     alert($(this).val());
  });
...
$(document).ready(function(){ $("input:radio[name=BedRooms]").click(function(){
    // window.location.replace("http://google.com/");
    // window.open(this.href, "http://google.com");
     alert($(this).val());
  });
...
$(document).ready(function(){ $("input:radio[name=BathRooms]").click(function(){
    // window.location.replace("http://google.com/");
    // window.open(this.href, "http://google.com");
     alert($(this).val());
  });
